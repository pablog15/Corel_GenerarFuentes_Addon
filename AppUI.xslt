...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:frmwrk="Corel Framework Data">
  ...
  <xsl:template match="uiConfig/items">
    <xsl:copy>
      ...
      <itemData guid="a134c124-47f8-4a7c-b372-cd394421fe64"
                type="wpfhost"
                hostedType="Addons\\.dll,Generar_Fuentes.ControlUI"
                enable="true"/>
    ...
    <xsl:copy>
      <xsl:apply-templates select="node()|@*"/>
        ...
        <container>
          ...
          <item dock="fill" margin="0,0,0,0" guidRef="a134c124-47f8-4a7c-b372-cd394421fe64"/>
        </container>
